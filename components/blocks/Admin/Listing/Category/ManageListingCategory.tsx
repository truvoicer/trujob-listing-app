...
export const EDIT_LISTING_CATEGORY_MODAL_ID = 'edit-listing-category-modal';
export const CREATE_LISTING_CATEGORY_MODAL_ID = 'create-listing-category-modal';
export const DELETE_LISTING_CATEGORY_MODAL_ID = 'delete-listing-category-modal';
                ...
                onSubmit: async (values: FormikValues) => {
                    ...
                    if (['add', 'create'].includes(operation)) {
                        ...
                        if (typeof onChange === 'function') {
                            onChange([
                                ...origData,
                                ...values?.categories.filter((item: any) => {
                    ...
                    const ids = RequestHelpers.extractIdsFromArray(values?.categories);
                    ...
                    notificationContext.show({
                        ...
                        title: 'Success',
                        component: (
                            <p>Added listing categories</p>
                        ),
                    }, 'listing-category-add-success');
                    dataTableContext.refresh();
                    dataTableContext.modal.close('create-listing-category-modal');
                    return true;
                }
            },
            show: true,
                        ...
                        dataTableContextState.modal.show({
                            ...
                            component: (
                                <EditListingCategory
                                    ...
                                    operation={'edit'}
                                    inModal={true}
                                    modalId={EDIT_LISTING_CATEGORY_MODAL_ID}
                                />
                            ),
                            ...getListingFormModalProps(),
                        }, EDIT_LISTING_CATEGORY_MODAL_ID);
                    }}
                >
                ...
                <Link className="badge bg-danger-light mr-2"
                    ...
                    onClick={e => {
                        ...
                        dataTableContext.modal.show({
                            ...
                            component: (
                                <p>Are you sure you want to delete this category ({item?.label})?</p>
                            ),
                            onOk: async () => {
                                if (!operation) {
                                    console.warn('Operation is required');
                                ...
                                if (['add', 'create'].includes(operation)) {
                                    ...
                                    dataTableContext.modal.close(DELETE_LISTING_CATEGORY_MODAL_ID);
                                    return;
                                }
                                if (!item?.id) {
                                    notificationContext.show({
                                ...
                                if (!response) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Failed to delete listing category</p>
                                        ),
                                    }, 'listing-category-delete-error');
                                    return;
                                }
                            ...
                            show: true,
                            showFooter: true
                        }, DELETE_LISTING_CATEGORY_MODAL_ID);
                    }}
                >
                    <i className="lar la-eye"></i>
                </Link>
