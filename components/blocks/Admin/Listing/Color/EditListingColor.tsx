...
import { CREATE_LISTING_COLOR_MODAL_ID, EDIT_COLOR_MODAL_ID, EDIT_LISTING_COLOR_MODAL_ID } from "./ManageListingColor";
...
function EditListingColor({
    ...
    async function handleSubmit(values: {colors: Array<Color>}) {
            ...
            if (!data?.id) {
                console.log('Listing color ID is required');
                return;
            }
            ...
            dataTableContext.modal.close(EDIT_LISTING_COLOR_MODAL_ID);
            dataTableContext.modal.close(CREATE_LISTING_COLOR_MODAL_ID);
    }
