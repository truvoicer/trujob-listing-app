...
export const ADDRESS_UPDATE_ERROR_NOTIFICATION_ID = 'address-update-error-notification';
export const ADDRESS_DELETE_ERROR_NOTIFICATION_ID = 'address-delete-error-notification';
export const ADDRESS_CREATE_SUCCESS_NOTIFICATION_ID = 'address-create-success-notification';
export const ADDRESS_UPDATE_SUCCESS_NOTIFICATION_ID = 'address-update-success-notification';
export const ADDRESS_DELETE_SUCCESS_NOTIFICATION_ID = 'address-delete-success-notification';
...
function ManageAddress({
    ...
    function handleEditAddress(e: React.MouseEvent, item: Address, type: 'billing' | 'shipping') {
        e.preventDefault();
        modalContext.show({
            title: 'Edit Address',
            component: (
    ...
    function handleCreateAddress(e: React.MouseEvent, type: 'billing' | 'shipping') {
        e.preventDefault();
        modalContext.show({
                ...
                <div className="col-xl-3 col-lg-4 col-md-6">
                    <div className="card card-block card-stretch card-height cursor-pointer">
                        ...
                        >
                            ...
                            <h5 className="mb-2">
                                Add New {uCaseFirst(type)} Address
                            </h5>
