...
export interface ManageCategoryEntityProps extends DataManageComponentProps {
  data?: Array<Category>;
  values?: Category[];
}
...
export default ManageCategoryEntity;
