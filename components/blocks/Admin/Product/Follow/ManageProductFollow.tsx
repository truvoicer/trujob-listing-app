...
function ManageProductFollow({
                        ...
                        dataTableContextState.modal.show({
                            ...
                            component: (
                                <EditProductFollow
                                    ...
                                    operation={'edit'}
                                    inModal={true}
                                    modalId={EDIT_PRODUCT_FOLLOW_MODAL_ID}
                                />
                            ),
                            ...getProductFormModalProps(index),
                        }, EDIT_PRODUCT_FOLLOW_MODAL_ID);
                    }}
                >
                        ...
                        dataTableContext.modal.show({
                            ...
                            onOk: async () => {
                                ...
                                if (['add', 'create'].includes(operation)) {
                                    ...
                                    dataTableContext.modal.close(DELETE_PRODUCT_FOLLOW_MODAL_ID);
                                    return;
                                }
                                if (!productId) {
                                ...
                                if (!response) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Failed to delete product follow</p>
                                        ),
                                    }, 'product-follow-delete-error');
                                    return;
                                }
                            ...
                            show: true,
                            showFooter: true
                        }, DELETE_PRODUCT_FOLLOW_MODAL_ID);
                    }}
                >
                    <i className="lar la-eye"></i>
                </Link>
                                        ...
                                        onOk: async () => {
                                            ...
                                            if (!item?.id) {
                                                notificationContext.show({
                                                    ...
                                                    title: 'Error',
                                                    component: (
                                                        <p>Product follow ID is required</p>
                                                    ),
                                                }, 'product-follow-delete-error');
                                                return;
                                            }
    ...
    function renderAddNew(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, { dataTableContextState, setDataTableContextState }: {
        ...
        }, CREATE_PRODUCT_FOLLOW_MODAL_ID);
    }
