...
function SelectColor({
    ...
    const [colors, setColors] = useState<Array<ProductColor>>([]);
    ...
    useEffect(() => {
        if (value) {
            const findColor = colors.find((color: ProductColor) => color?.id === value);
        ...
        <div className="floating-input form-group">
            <select
                ...
                onChange={e => {
                    ...
                    const findColor = colors.find((color: ProductColor) => color?.id === parseInt(e.target.value));
                    if (!findColor) {
