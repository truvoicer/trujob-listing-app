                ...
                <Link className="badge bg-success-light mr-2"
                    ...
                    onClick={e => {
                        ...
                        dataTable={dataTableContextState}                                     productId={productId}
                                    ...
                                    operation={'edit'}
                                    inModal={true}
                                    modalId={EDIT_PRODUCT_COLOR_MODAL_ID}
                                />
                            ),
                            ...getProductFormModalProps(index),
                        }, EDIT_PRODUCT_COLOR_MODAL_ID);
                    }}
                >
                        ...
                        dataTableContext.modal.show({
                            ...
                            onOk: async () => {
                                ...
                                if (['add', 'create'].includes(operation)) {
                                    ...
                                    dataTableContext.modal.close(DELETE_PRODUCT_COLOR_MODAL_ID);
                                    return;
                                }
                                if (!productId) {
                                ...
                                if (!response) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Failed to delete product color</p>
                                        ),
                                    }, 'product-color-delete-error');
                                    return;
                                }
                                        ...
                                        onOk: async () => {
                                            ...
                                            if (!item?.id) {
                                                notificationContext.show({
                                                    ...
                                                    title: 'Error',
                                                    component: (
                                                        <p>Product color ID is required</p>
                                                    ),
                                                }, 'product-color-delete-error');
                                                return;
                                            }
