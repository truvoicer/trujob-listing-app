...
function ManageProductCategory({
                        ...
                        dataTableContextState.modal.show({
                            ...
                            component: (
                                <EditProductCategory
                                    ...
                                    operation={'edit'}
                                    inModal={true}
                                    modalId={EDIT_PRODUCT_CATEGORY_MODAL_ID}
                                />
                            ),
                            ...getProductFormModalProps(index),
                        }, EDIT_PRODUCT_CATEGORY_MODAL_ID);
                    }}
                >
                        ...
                        dataTableContext.modal.show({
                            ...
                            onOk: async () => {
                                ...
                                if (['add', 'create'].includes(operation)) {
                                    ...
                                    dataTableContext.modal.close(DELETE_PRODUCT_CATEGORY_MODAL_ID);
                                    return;
                                }
                                if (!item?.id) {
                                    ...
                                    }, 'product-category-delete-error');
                                    return;
                                }
                                const response = await TruJobApiMiddleware.getInstance().resourceRequest({
                                    endpoint: UrlHelpers.urlFromArray([
                                        truJobApiConfig.endpoints.productCategory.replace(':productId', productId.toString()),
                                        item.id,
                                        'delete'
                                    ]),
                                ...
                                if (!response) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Failed to delete product category</p>
                                        ),
                                    }, 'product-category-delete-error');
                                    return;
                                }
                            ...
                            show: true,
                            showFooter: true
                        }, DELETE_PRODUCT_CATEGORY_MODAL_ID);
                    }}
                >
                    <i className="lar la-eye"></i>
                </Link>
    ...
    function renderAddNew(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, { dataTableContextState, setDataTableContextState }: {
        ...
        }, CREATE_PRODUCT_CATEGORY_MODAL_ID);
    }
