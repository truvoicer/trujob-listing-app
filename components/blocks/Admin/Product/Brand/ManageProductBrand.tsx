...
export interface ManageProductBrandProps extends DataManageComponentProps {
    data?: Array<Brand>;
    productId?: number;
}
export const EDIT_PRODUCT_BRAND_MODAL_ID = 'edit-product-brand-modal';
export const DELETE_PRODUCT_BRAND_MODAL_ID = 'delete-product-brand-modal';
export const CREATE_PRODUCT_BRAND_MODAL_ID = 'create-product-brand-modal';
...
function ManageProductBrand({
                        ...
                        dataTableContextState.modal.show({
                            ...
                            component: (
                                <EditProductBrand
                                    ...
                                    operation={'edit'}
                                    inModal={true}
                                    modalId={EDIT_PRODUCT_BRAND_MODAL_ID}
                                />
                            ),
                            ...getProductFormModalProps(index),
                        }, EDIT_PRODUCT_BRAND_MODAL_ID);
                    }}
                >
                        ...
                        dataTableContext.modal.show({
                            ...
                            onOk: async () => {
                                ...
                                if (['add', 'create'].includes(operation)) {
                                    ...
                                    dataTableContext.modal.close(DELETE_PRODUCT_BRAND_MODAL_ID);
                                    return;
                                }
                                if (!productId) {
                                ...
                                if (!item?.id) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Product brand ID is required</p>
                                        ),
                                    }, 'product-brand-delete-error');
                                    return;
                                }
                                ...
                                if (!response) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Failed to delete product brand</p>
                                        ),
                                    }, 'product-brand-delete-error');
                                    return;
                                }
    ...
    async function productRequest({ dataTableContextState, setDataTableContextState, searchParams }: {
        ...
        return await TruJobApiMiddleware.getInstance().resourceRequest({
            endpoint: UrlHelpers.urlFromArray([
                truJobApiConfig.endpoints.productBrand.replace(':productId', productId.toString()),
            ]),
    ...
    function renderAddNew(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, { dataTableContextState, setDataTableContextState }: {
        ...
        e.preventDefault();
        // e.stopPropagation();
        console.log('Add New Product Brand', dataTableContext.modal);
        dataTableContext.modal.show({
