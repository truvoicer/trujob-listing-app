...
export const EDIT_PRODUCT_PRODUCT_TYPE_MODAL_ID = 'edit-product-product-type-modal';
export const DELETE_PRODUCT_PRODUCT_TYPE_MODAL_ID = 'delete-product-product-type-modal';
export const CREATE_PRODUCT_PRODUCT_TYPE_MODAL_ID = 'create-product-product-type-modal';
                        ...
                        dataTableContextState.modal.show({
                            ...
                            component: (
                                <EditProductProductType
                                    ...
                                    operation={'edit'}
                                    inModal={true}
                                    modalId={EDIT_PRODUCT_PRODUCT_TYPE_MODAL_ID}
                                />
                            ),
                            ...getProductFormModalProps(index),
                        }, EDIT_PRODUCT_PRODUCT_TYPE_MODAL_ID);
                    }}
                >
                ...
                <Link className="badge bg-danger-light mr-2"
                    ...
                    onClick={e => {
                        ...
                        dataTableContext.modal.show({
                            title: 'Delete Product ProductType',
                            component: (
                            ...
                            onOk: async () => {
                                ...
                                if (['add', 'create'].includes(operation)) {
                                    ...
                                    dataTableContext.modal.close(DELETE_PRODUCT_PRODUCT_TYPE_MODAL_ID);
                                    return;
                                }
                                if (!productId) {
                                    ...
                                    }, 'product-productType-delete-error');
                                    return;
                                }
                                if (!item?.id) {
                                    notificationContext.show({
                                ...
                                if (!response) {
                                    notificationContext.show({
                                        ...
                                        title: 'Error',
                                        component: (
                                            <p>Failed to delete product productType</p>
                                        ),
                                    }, 'product-productType-delete-error');
                                    return;
                                }
                            ...
                            show: true,
                            showFooter: true
                        }, DELETE_PRODUCT_PRODUCT_TYPE_MODAL_ID);
                    }}
                >
                    <i className="lar la-eye"></i>
                </Link>
                                    ...
                                    appModalContext.show({
                                        ...
                                        onOk: async () => {
                                            if (!productId) {
                                                ...
                                                }, 'product-product-type-delete-error');
                                                return;
                                            }
                                            if (!item?.id) {
                                                notificationContext.show({
                                                    ...
                                                    title: 'Error',
                                                    component: (
                                                        <p>Product product type ID is required</p>
                                                    ),
                                                }, 'product-product-type-delete-error');
                                                return;
                                            }
                                            ...
                                            if (!response) {
                                                notificationContext.show({
                                                    ...
                                                    title: 'Error',
                                                    component: (
                                                        <p>Failed to delete product product type</p>
                                                    ),
                                                }, 'product-product-type-delete-error');
                                                return;
                                            }
            ...
            component: ({
                ...
                return (
                    <EditProductProductType
                        ...
                        operation={operation}
                        inModal={true}
                        modalId={CREATE_PRODUCT_PRODUCT_TYPE_MODAL_ID}
                    />
                )
            },
