...
const Pagination = ({
    ...
    function getLastPageNumber() {
        if (data?.[ProductsFetch.PAGINATION.LAST_PAGE]) {
            return data[ProductsFetch.PAGINATION.LAST_PAGE];
        }
        if (data?.[ProductsFetch.PAGINATION.TOTAL_PAGES] && data?.[ProductsFetch.PAGINATION.TOTAL_ITEMS]) {
            const calculate = Math.ceil(
                data[ProductsFetch.PAGINATION.TOTAL_ITEMS] / data[ProductsFetch.PAGINATION.PAGE_SIZE]
            );
            return calculate;
        }
        return 1;
    ...
    function getCurrentPageNumber() {
        ...
        return data?.[ProductsFetch.PAGINATION.CURRENT_PAGE] || 1;
    }
    ...
    }, [data?.[ProductsFetch.PAGINATION.PAGE], pageQueryVal]);
